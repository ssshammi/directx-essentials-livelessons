...
namespace Rendering
{
	...
	void PointLightDemo::Initialize()
	{
		...
		ThrowIfFailed(DirectX::CreateWICTextureFromFile(mGame->Direct3DDevice(), textureName.c_str(), nullptr, mSpecularMap.ReleaseAndGetAddressOf()), "CreateWICTextureFromFile() failed.");
