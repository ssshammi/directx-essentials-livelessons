...
namespace Rendering
{
	class TransparencyMappingMaterial : public Library::Material
	{
		RTTI_DECLARATIONS(TransparencyMappingMaterial, Library::Material)

	public:
		TransparencyMappingMaterial(Library::Game& game, std::shared_ptr<Library::Texture2D> colormap, std::shared_ptr<Library::Texture2D> specularMap, std::shared_ptr<Library::Texture2D> transparencyMap);
		TransparencyMappingMaterial(const TransparencyMappingMaterial&) = default;
		TransparencyMappingMaterial& operator=(const TransparencyMappingMaterial&) = default;
		TransparencyMappingMaterial(TransparencyMappingMaterial&&) = default;
		TransparencyMappingMaterial& operator=(TransparencyMappingMaterial&&) = default;
		virtual ~TransparencyMappingMaterial() = default;
